void pause() {
  ...
  textSize(30);
  if (hUpgNum == 6) {
    text("Max " + "Hero Health:", width/4 + 60, height/2);
  } else {
    text("Lv " + (hUpgNum + 1) + " Hero Health:", width/4 + 60, height/2);
  }
  ...
  textSize(30);
  if (dUpgNum == 6) {
    text("Max " + "Gun Damage:", width/4 + 60, height/2 + 80);
  } else {
    text("Lv " + (dUpgNum + 1) + " Gun Damage:", width/4 + 60, height/2 + 80);
  }
  ...
  textSize(30);
  if (sUpgNum == 6) {
    text("Max " + "Hero Speed:", width/4 + 60, height/2 + 160);
  } else {
    text("Lv " + (sUpgNum + 1) + " Hero Speed:", width/4 + 60, height/2 + 160);
  }
